...
namespace HenryBooksEF.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(cottrell2021Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AuthorNum,AuthorLast,AuthorFirst")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("AuthorNum,AuthorLast,AuthorFirst")] Author author)
        {
